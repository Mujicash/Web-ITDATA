...
<div class="modal fade" id="modalInscripcion" tabindex="-1" aria-labelledby="modalInscripcionLabel" aria-hidden="true">
	...
	<div class="modal-content">
		...
		<button class="btn btn-primary" onclick="validarForm()"> <i class="bi-pencil-square pe-2"></i>Inscribirme </button>
		</div>
	</div>
	</div>
</div>
		...
		<div class="col-lg-4"> 
			<div class="card mb-4 mx-auto" style="max-width:500px">
				...
				<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
					<div class="text-center"><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalInscripcion"><i class="bi-pencil-square pe-2"></i>Inscribirme</button></div>
				</div>
			</div>
		</div>
